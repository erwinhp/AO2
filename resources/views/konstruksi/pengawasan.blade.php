...
<br>
      ...
      <form class="form-horizontal">
        ...
        <!-- <div class="form-group row">
          ...
          <div class="col-sm-9">
            <input type="text" placeholder="No PRK" class="form-control" name="no_prk" id="prkszs" value="{{ old('pekerjaan') }}" disabled>
            </div>
        </div> -->
        ...
        <div class="form-group row">
          ...
          <div class="col-sm-9">
            <input type="text" placeholder="Nama Pekerjaan" class="form-control" name="material_kontrak" id="nama_pekerjaan"  value="{{ old('material_kontrak') }}" readonly>
            <!-- yg value= gak harus -->
          </div>
        </div>
        ...
        <div class="form-group row">
          ...
          <div class="col-sm-9">
            <input type="text" placeholder="pekerjaan" class="form-control" name="pekerjaan" id="nilai_kontrak" value="{{ old('pekerjaan') }}" disabled>
            <!-- yg value= gak harus -->
          </div>
        </div>
        ...
        <div class="form-group row">
          ...
          <div class="col-sm-9">
            <input type="text" placeholder="Jangka Waktu" class="form-control" name="jangka_waktu" id="jangka_waktu" value="{{ old('pekerjaan') }}" disabled>
            <!-- yg value= gak harus -->
          </div>
        </div>
        ...
        <div class="form-group row">
          ...
          <div class="col-sm-9">
            <input type="text" placeholder="no_addendum" class="form-control" name="material_kontrak" id="no_addendum"  value="{{ old('material_kontrak') }}" readonly>
            <!-- yg value= gak harus -->
          </div>
        </div>
        ...
        <div class="form-group row">
          ...
          <div class="col-sm-9">
            <input type="text" placeholder="Periode Penilaian Ex: MMYYYY" class="form-control" name="material_kontrak" id="periode_penilaian"  value="{{ old('material_kontrak') }}">
            <!-- yg value= gak harus -->
          </div>
        </div>
...
<!-- ASPEK PENILAIAN MADUDE -->
        ...
        <div class="form-group row">
          ...
          <div class="col-sm-9">
            <input type="text" placeholder="Tenaga Kerja" class="form-control" name="jumlah_tenaga_kerja" id="jumlah_tk"  value="{{ old('material_kontrak') }}">
            <!-- yg value= gak harus -->
          </div>
        </div>
        ...
        <div class="form-group row">
          ...
          <div class="col-sm-9">
            <input type="text" placeholder="Jumlah TK Bersertifikasi" class="form-control" name="sertifikasi_tk" id="sertifikasi_tk"  value="{{ old('material_kontrak') }}">
            <!-- yg value= gak harus -->
          </div>
        </div>
        ...
        <div class="form-group row">
          ...
          <div class="col-sm-9">
            <input type="text" placeholder="Bobot Kualitas" class="form-control" name="sarana_alat_k3_3" id="sarana_alat_k3_3"  value="{{ old('material_kontrak') }}">
            <!-- yg value= gak harus -->
          </div>
        </div>
        ...
        <div class="form-group row">
          ...
          <div class="form-group row">
            ...
            <div class="form-group row">
              <label class="col-sm-3 form-control-label">Material Kerja</label>
              <div class="col-sm-9">
                <input type="text" placeholder="Material Kerja" class="form-control" name="material_kerja1" id="material_kerja3"  value="{{ old('material_kontrak') }}">
                <!-- yg value= gak harus -->
              </div>
            </div>
        ...
        <div class="form-group row">
          <label class="col-sm-3 form-control-label">Komunikasi Korespondensi</label>
          <div class="col-sm-9">
            <input type="text" placeholder="Media Komunikasi dan Kendala" class="form-control" name="material_kontrak" id="komunikasi_koresponden_2"  value="{{ old('material_kontrak') }}">
            <!-- yg value= gak harus -->
          </div>
        </div>
        ...
        <div class="form-group row">
          <label class="col-sm-3 form-control-label">Kepatuhan Pelaporan</label>
          <div class="col-sm-9">
            <input type="text" placeholder="Kepatuhan rekanan dan kendala" class="form-control" name="kepatuhan_pelaporan_2" id="kepatuhan_pelaporan_2"  value="{{ old('material_kontrak') }}">
            <!-- yg value= gak harus -->
          </div>
        </div>
        ...
        <div class="form-group row">
          ...
          <div class="col-sm-9">
            <input type="text" placeholder="Berapa Accident" class="form-control" name="material_kontrak" id="k3_accident"  value="{{ old('material_kontrak') }}">
            <!-- yg value= gak harus -->
          </div>
        </div>
        ...
        <div class="form-group row">
          ...
          <div class="col-sm-9">
            <input type="text" placeholder="Penjelasan K3" class="form-control" name="material_kontrak" id="pelaksanaan_k3"  value="{{ old('material_kontrak') }}">
            <!-- yg value= gak harus -->
          </div>
        </div>
        ...
        <div class="form-group row">
          ...
          <div class="col-sm-9">
            <input type="text" placeholder="Prosentase Pekerjaan" class="form-control" name="prosentase_laporan" id="prosentase_laporan"  value="{{ old('material_kontrak') }}">
            <!-- yg value= gak harus -->
          </div>
        </div>
        ...
        <div class="form-group row">
          ...
          <div class="col-sm-9">
            <input type="text" placeholder="prosentase komulatif" class="form-control" name="prosentase_komulatif" id="prosentase_komulatif"  value="{{ old('material_kontrak') }}">
            <!-- yg value= gak harus -->
          </div>
        </div>
