    ...
    <div class="row">
      <div class="col-lg-12">
        <div class="card">
          ...
          <div class="card-header d-flex align-items-center">
            <h3 class="h4">Table Transport RAB {{$rab}}</h3>
          </div>
          <div class="card-body">
            <div class="table-responsive">
              <table id="postTable" class="display" style="width:100%">
  ...
  <div class="modal-content">
      ...
      <div class="modal-body">
          <form id="sample_form" name="userForm" class="form-horizontal" enctype="multipart/form-data">
            @csrf
            <input type="hidden" name="kontrak" id="kontrak" value="{{$no_kontrak}}">
             <input type="hidden" name="no_rab" id="no_rabtr" value="{{$rab}}">
             ...
             <div class="form-group">
                 ...
                 <div class="col-sm-12">
                     <input type="jumlah" class="form-control" id="satuantr" name="satuantr" placeholder="Enter jumlah" value="" required="">
                 </div>
             </div>
  ...
  <div class="modal-content">
      ...
      <div class="modal-body">
          <form id="sample_form" name="userForm" class="form-horizontal" enctype="multipart/form-data">
            ...
            <input type="hidden" name="no_rab" id="no_rabtr1" value="{{$rab}}">
...
<div class="modal-content">
    ...
    <div class="modal-body">
        <form id="sample_form" name="userForm" class="form-horizontal" enctype="multipart/form-data">
          ...
          <input type="hidden" name="no_spbj" id="no_spbj" value="{{$no_spbj}}">
