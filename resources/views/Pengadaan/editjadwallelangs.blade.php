      ...
      <form class="form-horizontal">
        ...
        <div class="form-group row">
          <div class="col-sm-4 offset-sm-3 addkontrak">
            ...
            <button type="button" class="btn btn-success add" id="addkont">Edit</button>
          </div>
        </div>
      </form>
...
||($('#ba_cda').val()=="")||($('#no_kontrak').val()=="")||($('#id_madude').val()==""))
  {
