...
<?php echo csrf_field(); ?>
              ...
              <div class="form-group row">
                ...
                <div class="col-sm-9">
                  <input type="text" placeholder="No PK" class="form-control" name="no_skk" id="no_pk"  value="<?php echo e(old('no_skk')); ?>">
                  <!-- yg value= gak harus -->
                </div>
              </div>
              ...
              <div class="form-group row">
                ...
                <div class="col-sm-9">
                  <input type="text" placeholder="Judul" class="form-control" name="pekerjaan" id="judul" value="<?php echo e(old('pekerjaan')); ?>" disabled>
                  <!-- yg value= gak harus -->
                </div>
              </div>
              ...
              <div class="form-group row">
                ...
                <div class="col-sm-9">
                  <input type="text" placeholder="No SPBJ" class="form-control" name="pekerjaan" id="no_spbj" value="<?php echo e(old('pekerjaan')); ?>" disabled>
                  <!-- yg value= gak harus -->
                </div>
              </div>
              ...
              <div class="form-group row">
                ...
                <div class="col-sm-9">
                  <input type="text" placeholder="Nama Vendor" class="form-control" name="pekerjaan" id="vendor" value="<?php echo e(old('pekerjaan')); ?>" disabled>
                  <!-- yg value= gak harus -->
                </div>
              </div>
              ...
              <div class="form-group row">
                ...
                <div class="col-sm-9">
                  <input type="text" placeholder="Nilai" class="form-control" name="pekerjaan" id="nilai" value="<?php echo e(old('pekerjaan')); ?>" disabled>
                  <!-- yg value= gak harus -->
                </div>
              </div>
