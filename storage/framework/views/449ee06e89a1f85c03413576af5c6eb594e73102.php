   ...
   <div class="modal-body">
      ...
      <form class="form-horizontal">
        ...
        <div class="form-group row">
          ...
          <div class="col-sm-9">
            <input type="text" placeholder="pekerjaan" class="form-control" name="pekerjaan" id="pekerjaan" value="<?php echo e(old('pekerjaan')); ?>">
            <!-- yg value= gak harus -->
          </div>
        </div>
        ...
        <div class="form-group row">
          ...
          <div class="col-sm-9">
            <input type="text" placeholder="Vendor" class="form-control" name="vendor" id="vendor"  value="<?php echo e(old('vendor')); ?>">
            <!-- yg value= gak harus -->
          </div>
        </div>
        ...
        <div class="form-group row">
          ...
          <div class="col-sm-9">
            <input type="text" placeholder="Total Kontrak" class="form-control" name="total_kontrak" id="total_kontrak"  value="<?php echo e(old('total_kontrak')); ?>">
            <!-- yg value= gak harus -->
          </div>
        </div>
        ...
        <div class="form-group row">
          ...
          <div class="col-sm-9">
            <input type="text" placeholder="Material Bayar" class="form-control" id="material_bayar" name="material_bayar"  value="<?php echo e(old('material_bayar')); ?>">
            <!-- yg value= gak harus -->
          </div>
        </div>
        ...
        <div class="form-group row">
          ...
          <div class="col-sm-9">
            <input type="text" placeholder="Jasa Bayar" class="form-control" name="jasa_bayar" id="jasa_bayar"  value="<?php echo e(old('jasa_bayar')); ?>">
            <!-- yg value= gak harus -->
          </div>
        </div>
        ...
        <div class="form-group row">
          ...
          <div class="col-sm-9">
            <input type="text" placeholder="Total Bayar" class="form-control" name="total_bayar" id="total_bayar"  value="<?php echo e(old('total_bayar')); ?>">
            <!-- yg value= gak harus -->
          </div>
        </div>
        ...
        <div class="form-group row">
          ...
          <div class="col-sm-9">
            <select  class="form-control mb-3" name="aktif_bastp" id="aktif_bastp"  value="<?php echo e(old('aktif_bastp')); ?>">
              <option>Option</option>
              <option value="YES">YES</option>
              <option value="NO">NO</option>
            </select>
        ...
        <div class="form-group row">
          ...
          <div class="col-sm-9">
            <select  class="form-control mb-3" name="aktif_byr" id="aktif_byr"  value="<?php echo e(old('aktif_byr')); ?>">
              <option>Option</option>
              <option value="YES">YES</option>
              <option value="NO">NO</option>
            </select>
...
<?php echo $__env->make('layouts.indexNVM', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\project\git\AO2\resources\views/input/inputMA.blade.php ENDPATH**/ ?>