...
<br>
      ...
      <form class="form-horizontal">
        ...
        <div class="form-group row">
          ...
          <div class="col-sm-9">
            <input type="text" placeholder="Input No RKS" class="form-control" name="nama_perusahaan" id="no_rks"  value="<?php echo e(old('no_rks')); ?>">
            <!-- yg value= gak harus -->
          </div>
        </div>
        ...
        <div class="form-group row">
          ...
          <div class="col-sm-9">
            <input type="text" placeholder="" class="form-control" name="nomor_kontak" id="nama_pekerjaan"  value="<?php echo e(old('')); ?>" disabled>
            <!-- yg value= gak harus -->
          </div>
        </div>
...
<?php echo $__env->make('layouts.indexNVM', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\git\AO2\resources\views/Pengadaan/metode_lelangs.blade.php ENDPATH**/ ?>